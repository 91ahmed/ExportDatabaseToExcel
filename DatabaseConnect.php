<?php
	...
	/** Implementation
		--------------
		use PdoDatabaseConnect;

		$connect = new DatabaseConnect();
		$connect->setConfig('driver', 'pgsql');
		$connect->setConfig('host', 'localhost');
		$connect->setConfig('username', 'postgres');
		$connect->setConfig('password', '24882533');
		$connect->setConfig('database', 'shop_app');
		$connect->setConfig('port', 5432);
		$connect->setConfig('sslmode', 'require');
		$connect->connect();
	**/
?>